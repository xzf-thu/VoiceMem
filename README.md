...
* 🤖 **08/21/2026** — 开源 **VoiceMem 模型系列**（Qwen2.5-Omni / Qwen3-Omni / Step-Audio2-Mini），可直接读取并理解 VoiceMem 提供的记忆。
* 🛠️ **08/21/2026** — 发布 **VoiceMem Utils**，打包全部默认本地模型，开箱即用。
* 📦 **08/20/2026** — 开源 **ChatMem-400K** 数据集，由三阶段 OPD 流程构建。
